...
#ifndef NEBULA_HesaiRosDecoderTestXt32m_H
#define NEBULA_HesaiRosDecoderTestXt32m_H
...
namespace ros
{
/// @brief Testing decorder of XT32M (Keeps HesaiDriverRosWrapper structure as much as possible)
...
#endif  // NEBULA_HesaiRosDecoderTestXt32m_H
