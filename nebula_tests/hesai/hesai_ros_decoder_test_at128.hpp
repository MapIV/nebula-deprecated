...
namespace ros
{
/// @brief Testing decorder of AT128 (Keeps HesaiDriverRosWrapper structure as much as possible)
class HesaiRosDecoderTest final : public rclcpp::Node, NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for AT128 is described, each function can be integrated if the ros parameter can be passed to Google Test)
