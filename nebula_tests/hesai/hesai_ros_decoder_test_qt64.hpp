#ifndef NEBULA_HesaiRosDecoderTestQt64_H
...
namespace ros
{
/// @brief Testing decorder of QT64 (Keeps HesaiDriverRosWrapper structure as much as possible)
class HesaiRosDecoderTest final : public rclcpp::Node, NebulaDriverRosWrapperBase  //, testing::Test
{
  ...
  /// @brief Get configurations (Magic numbers for QT64 is described, each function can be integrated if the ros parameter can be passed to Google Test)
...
#endif  // NEBULA_HesaiRosDecoderTestQt64_H
