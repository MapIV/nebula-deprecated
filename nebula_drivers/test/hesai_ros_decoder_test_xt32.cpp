#include "hesai_ros_decoder_test_xt32.hpp"
  ...
  drivers::HesaiCorrection & correction_configuration)
{
  ...
  bag_root_dir /= "hesai";
  {
    ...
    this->declare_parameter<std::string>("sensor_model", "PandarXT32");
  ...
  }
  {
    ...
    this->declare_parameter<std::string>(
      "calibration_file", (calib_dir / "PandarXT32.csv").string(), descriptor);
  ...
  }
  {
    ...
    descriptor.additional_constraints = "";
    this->declare_parameter<std::string>(
      "bag_path", (bag_root_dir / "xt32" / "1673400677802009732").string(), descriptor);
