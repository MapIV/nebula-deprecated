...
//    this->declare_parameter<std::string>("calibration_file", "", descriptor);
    this->declare_parameter<std::string>("calibration_file", (calib_dir / "PandarAT128.csv").string(), descriptor);
...
//    this->declare_parameter<std::string>("bag_path", "", descriptor);
    this->declare_parameter<std::string>("bag_path", (bag_root_dir / "at128" / "1671446145045082648").string(), descriptor);
