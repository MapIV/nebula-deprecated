...
void PandarQTDecoder::unpack(const hesai_msgs::msg::PandarPacket & pandar_packet)
{
...
bool PandarQTDecoder::parsePacket(const hesai_msgs::msg::PandarPacket & pandar_packet)
{
