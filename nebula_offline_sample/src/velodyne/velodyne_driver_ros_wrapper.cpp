#include "velodyne/velodyne_ros_offline_extract_pcd.hpp"
...
namespace ros
{
VelodyneRosOfflineExtractSample::VelodyneRosOfflineExtractSample(
...
void VelodyneRosOfflineExtractSample::ReceiveScanMsgCallback(
  const velodyne_msgs::msg::VelodyneScan::SharedPtr scan_msg)
{
}

Status VelodyneRosOfflineExtractSample::InitializeDriver(
...
Status VelodyneRosOfflineExtractSample::GetStatus() { return wrapper_status_; }

Status VelodyneRosOfflineExtractSample::GetParameters(
  drivers::VelodyneSensorConfiguration & sensor_configuration,
  drivers::VelodyneCalibrationConfiguration & calibration_configuration)
{
  {
...
Status VelodyneRosOfflineExtractSample::ReadBag()
{
...
//        std::cout<<"Found data in topic " << bag_message->topic_name << ": " << extracted_test_msg.data << std::endl;
        ...
        nebula::drivers::PointCloudXYZIRADTPtr pointcloud = driver_ptr_->ConvertScanToPointcloud(std::make_shared<velodyne_msgs::msg::VelodyneScan>(extracted_msg));
...
RCLCPP_COMPONENTS_REGISTER_NODE(VelodyneRosOfflineExtractSample)
} // namespace ros
} // namespace nebula